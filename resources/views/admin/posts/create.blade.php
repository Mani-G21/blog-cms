                    ...
                    <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="trix-button-row">
                                    <span class="trix-button-group trix-button-group--text-tools"
                                        ...
                                        <button type="button"
                                            ...
                                            data-trix-attribute="italic" data-trix-key="i" title="Italics"
                                            tabindex="-1">Italics</button>
                                        <button type="button"
                                            class="trix-button trix-button--icon trix-button--icon-strike"
                                            data-trix-attribute="strike" title="Strikg" tabindex="-1">Strikg</button>
                                    ...
                                    <span class="trix-button-group trix-button-group--block-tools"
                                        ...
                                        <button type="button"
                                            ...
                                            data-trix-attribute="heading1" title="Heading 1" tabindex="-1">Heading
                                            1</button>
                                    ...
                                    <span class="trix-button-group trix-button-group--file-tools"
                                        ...
                                        <button type="button"
                                            ...
                                            data-trix-action="attachFiles" title="Attach Files" tabindex="-1">Attach
                                            Files</button>
                                    </span>
                                    <span class="trix-button-group" data-trix-button-group="ai">
                                        <button id="generateArticleFromAI" type="button" class="trix-button"
                                            title="Generate Article With AI" tabindex="-1"><i
                                    ...
                                    <span class="trix-button-group trix-button-group--history-tools"
                                        ...
                                        <button type="button"
                                            ...
                                            data-trix-action="redo" data-trix-key="shift+z" title="Redo"
                                            tabindex="-1">Redo</button>
                                    </span>
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" accept="image/*"
                                ...
                                value="{{ old('thumbnail') }}" id="thumbnail" />
                            @error('thumbnail')
                                <span class="text-danger text-sm">{{ $message }}</span>
                            @enderror
                        </div>

...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item {{ \App\Helpers\RoutingHelper::isCategoryRoute() ? 'active' : '' }}">
        <a class="nav-link {{ \App\Helpers\RoutingHelper::isCategoryRoute() ? '' : 'collapsed' }}" href="#"
            data-toggle="collapse" data-target="#collapseCategory" aria-expanded="true"
            aria-controls="collapseCategory">
            <i class="fas fa-fw fa-cog"></i>
            <span>Category</span>
        </a>
        <div id="collapseCategory" class="collapse {{ \App\Helpers\RoutingHelper::isCategoryRoute() ? 'show' : '' }}"
    ...
    <li class="nav-item {{ \App\Helpers\RoutingHelper::isTagRoute() ? 'active' : '' }}">
        <a class="nav-link {{ \App\Helpers\RoutingHelper::isTagRoute() ? '' : 'collapsed' }}" href="#"
            data-toggle="collapse" data-target="#collapseTag" aria-expanded="true" aria-controls="collapseTag">
            <i class="fas fa-fw fa-cog"></i>
            <span>Tag</span>
        </a>
        <div id="collapseTag" class="collapse {{ \App\Helpers\RoutingHelper::isTagRoute() ? 'show' : '' }}"
            aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
    ...
    <a class="nav-link {{ \App\Helpers\RoutingHelper::isPostRoute() ? '' : 'collapsed' }}" href="#"
        ...
        <div id="collapsePost" class="collapse {{ \App\Helpers\RoutingHelper::isPostRoute() ? 'show' : '' }}"
            aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">

                <h6 class="collapse-header">Post Operations:</h6>
                <a class="collapse-item {{ \App\Helpers\RoutingHelper::isPostIndex() ? 'active' : '' }}"
                    href="{{ route('admin.posts.index') }}">Show All</a>
    ...
    <li class="nav-item {{ \App\Helpers\RoutingHelper::isUsersRoute() ? 'active' : '' }}">

        <a class="nav-link {{ \App\Helpers\RoutingHelper::isUsersRoute() ? '' : 'collapsed' }}" href="#"
            ...
            <div id="collapseUser" class="collapse {{ \App\Helpers\RoutingHelper::isUsersRoute() ? 'show' : '' }}"
                aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">

                    <h6 class="collapse-header">User Operations:</h6>
                    <a class="collapse-item {{ \App\Helpers\RoutingHelper::isUsersRoute() ? 'active' : '' }}"
